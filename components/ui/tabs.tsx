...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "inline-flex h-10 items-center justify-start lg:justify-center m-x-auto rounded-md  p-1 text-olive glossy backdrop-blur supports-[backdrop-filter]:bg-olive/20 !overflow-x-auto w-full lg:w-auto",
      className
    )}
    {...props}
  />
